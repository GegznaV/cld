...
✅ **Well-tested** - 250+ tests ensuring reliability across all methods   
...
- Groups with the same letter (e.g., casein and sunflower both have "a") are not significantly different. 
- Groups without shared letters (e.g., horsebean "b" and soybean "c") are significantly different.
