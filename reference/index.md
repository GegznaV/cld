...
## S3 Methods for make_cld

Methods for different input object types. These methods are
automatically dispatched based on the class of the input object.
...
Internal helper functions (not typically needed by end users).
